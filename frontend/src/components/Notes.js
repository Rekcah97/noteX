...
const Notes = (props) => {
  ...
  const checkVerifiedStatus = async () => {
    try {
      ...
      history.push("/login");
      showAlert("An error occurred, please log in again", "danger");
    }
  };
  // updating note
                ...
                <form>
                  ...
                  <div className="modal-header  flex-column border-0">
                    <div className="w-100 border-bottom">
                      ...
                      <input
                        ...
                        className="editmode form-control border-0 fs-1"
                        id="etitle"
                        name="etitle"
                      ...
                      <div className="icons d-flex mb-1">
                        ...
                        <input
                          type="text"
                          className="form-control border-0 editmode"
                          id="etag"
                          name="etag"
                          onChange={onChange}
                          value={note.etag}
                  ...
                  <div className="modal-body">
                    <div className="mb-3 pt-3">
                      ...
                      <textarea
                        type="text"
                        className="form-control border-0 editmode asize"
                        id="edescription"
                        name="edescription"
                        onChange={onChange}
          ...
          <div className="row my-3">
            <div className="emptynote mx-1">
              <h2 style={{ color: "#696969" }}>
                {notes.length === 0 && "No Notes To be Found !!!!"}
              </h2>
            </div>
            {notes.map((notes) => {
              return (
